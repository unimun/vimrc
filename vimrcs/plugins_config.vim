...
" => FZF
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
let $FZF_DEFAULT_OPTS .= ' --inline-info --bind "alt-a:select-all,alt-d:deselect-all,up:preview-up,down:preview-down"'
...
nnoremap <silent> <Leader>L        :BLines <C-R><C-W><CR>
xnoremap <silent> <Leader>L        y:BLines <C-R>"<CR>
...
autocmd VimEnter * if !exists('g:this_obsession') && argc() == 1 && isdirectory(argv()[0]) && !exists('s:std_in') |
